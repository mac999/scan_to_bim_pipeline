...
In reference, you can use [scan to model program (SMP)](https://github.com/mac999/scan_to_model_pipeline.git), simple 3D point cloud to model pipeline version and use Lightweight 3D Point Cloud Segmentation [PointEdgeSegNet](https://github.com/mac999/point_edge_seg_net) for large-scale point cloud segmentation.
</br>
