...
# build & installation
Modify the below PCL_ROOT(PCL library path), VTK_INC(VTK include path), USR_LIB paths in [CMakeLists.txt](https://github.com/mac999/scan_to_bim_pipeline/blob/main/CMakeLists.txt) properly</br>
